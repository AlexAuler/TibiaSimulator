...
export const S = {
  ...
  creature: {
    title: 'Alvos',
    tabPlace: 'Local de caça',
    tabCreature: 'Criatura',
    searchPlaceholder: 'Buscar criatura...',
    searchPlacePlaceholder: 'Buscar local de caça...',
    none: 'Nenhum alvo selecionado. Busque um local de caça ou uma criatura.',
    selectedTargets: (n: number) => (n === 1 ? '1 alvo selecionado' : `${n} alvos selecionados`),
    clearAll: 'Limpar alvos',
    placeCreatures: (n: number) => `${n} criaturas`,
    levelHint: 'level sugerido',
    hp: 'HP',
    armor: 'Armor',
  ...
  results: {
    ...
    pickCreature: 'Escolha um local de caça ou uma criatura-alvo para ver este painel.',
    vsCols: {
      creature: 'Criatura',
      effDps: 'DPS ef.',
      hits: 'Hits',
    ...
    vsHint: 'Uma linha por criatura selecionada. Clique na linha para ver detalhes.',
